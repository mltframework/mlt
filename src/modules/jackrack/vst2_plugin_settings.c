...
static void
vst2_settings_set_to_default (vst2_settings_t * settings, guint32 sample_rate)
{
...
vst2_settings_t *
vst2_settings_new     (vst2_plugin_desc_t * desc, unsigned long channels, guint32 sample_rate)
{
...
vst2_settings_t *
vst2_settings_dup     (vst2_settings_t * other)
{
  vst2_settings_t * settings;
      ...
      for (copy = 0; copy < settings->copies; copy++)
        {
          ...
          for (control = 0; control < desc->control_port_count; control++)
            {
              settings->control_values[copy][control] = vst2_settings_get_control_value (other, copy, control);
            }
        }
    }
...
void
vst2_settings_destroy (vst2_settings_t * settings)
{
...
static void
vst2_settings_set_copies (vst2_settings_t * settings, guint copies)
{
  guint copy;
  guint last_copy;
  unsigned long control;
...
static void
vst2_settings_set_channels (vst2_settings_t * settings, unsigned long channels)
{
  unsigned long channel;
...
void
vst2_settings_set_sample_rate (vst2_settings_t * settings, guint32 sample_rate)
{
...
void
vst2_settings_set_control_value (vst2_settings_t * settings, guint copy, unsigned long control_index, LADSPA_Data value)
{
  g_return_if_fail (settings != NULL);
...
void
vst2_settings_set_lock          (vst2_settings_t * settings, unsigned long control_index, gboolean locked)
{
  g_return_if_fail (settings != NULL);
  g_return_if_fail (control_index < settings->desc->control_port_count);
...
void
vst2_settings_set_lock_all (vst2_settings_t * settings, gboolean lock_all)
{
  g_return_if_fail (settings != NULL);
...
void
vst2_settings_set_enabled (vst2_settings_t * settings, gboolean enabled)
{
  g_return_if_fail (settings != NULL);
...
void
vst2_settings_set_wet_dry_enabled (vst2_settings_t * settings, gboolean enabled)
{
  g_return_if_fail (settings != NULL);
...
void
vst2_settings_set_wet_dry_locked  (vst2_settings_t * settings, gboolean locked)
{
  g_return_if_fail (settings != NULL);
...
void
vst2_settings_set_wet_dry_value   (vst2_settings_t * settings, unsigned long channel, LADSPA_Data value)
{
  g_return_if_fail (settings != NULL);
...
LADSPA_Data
vst2_settings_get_control_value (vst2_settings_t * settings, guint copy, unsigned long control_index)
{
...
gboolean
vst2_settings_get_lock          (const vst2_settings_t * settings, unsigned long control_index)
{
...
gboolean
vst2_settings_get_lock_all      (const vst2_settings_t * settings)
{
  g_return_val_if_fail (settings != NULL, FALSE);
...
gboolean
vst2_settings_get_enabled      (const vst2_settings_t * settings)
{
  g_return_val_if_fail (settings != NULL, FALSE);
...
guint
vst2_settings_get_copies        (const vst2_settings_t * settings)
{
...
unsigned long
vst2_settings_get_channels        (const vst2_settings_t * settings)
{
  g_return_val_if_fail (settings != NULL, 0);
...
gboolean
vst2_settings_get_wet_dry_enabled (const vst2_settings_t * settings)
{
  g_return_val_if_fail (settings != NULL, FALSE);
...
gboolean
vst2_settings_get_wet_dry_locked  (const vst2_settings_t * settings)
{
  g_return_val_if_fail (settings != NULL, FALSE);
...
LADSPA_Data
vst2_settings_get_wet_dry_value   (vst2_settings_t * settings, unsigned long channel)
{
  g_return_val_if_fail (settings != NULL, NAN);
