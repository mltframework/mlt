...
void vst2_context_add_saved_plugin (vst2_context_t * vst2_context, struct _vst2_saved_plugin * saved_plugin);

vst2_plugin_t * vst2_context_instantiate_plugin (vst2_context_t * vst2_context, vst2_plugin_desc_t * desc);
