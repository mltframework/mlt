...
vst2_context_t *
vst2_context_new (const char * client_name, unsigned long channels)
{
  vst2_context_t *rack;
...
void
vst2_context_destroy (vst2_context_t * vst2_context)
{
...
vst2_plugin_t *
vst2_context_instantiate_plugin (vst2_context_t * vst2_context, vst2_plugin_desc_t * desc)
{
...
void
vst2_context_add_saved_plugin (vst2_context_t * vst2_context, vst2_saved_plugin_t * saved_plugin)
{
  vst2_plugin_t * plugin = vst2_context_instantiate_plugin (vst2_context, saved_plugin->settings->desc);
  if (!plugin)
    {
...
void
vst2_context_add_plugin (vst2_context_t * vst2_context, vst2_plugin_t * plugin)
{
