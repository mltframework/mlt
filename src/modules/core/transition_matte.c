...
copy_Y_to_A_scaled_luma_sse(uint8_t *alpha_a, uint8_t *image_b, int cnt)
{
    const static unsigned char const1[] = {43, 0, 43, 0, 43, 0, 43, 0, 43, 0, 43, 0, 43, 0, 43, 0};
    const static unsigned char const2[] = {16, 0, 16, 0, 16, 0, 16, 0, 16, 0, 16, 0, 16, 0, 16, 0};
    ...
    __asm__ volatile("movdqu         (%[equ43]), %%xmm7      \n\t" /* load multiplier 43 */
...
static void copy_Y_to_A_scaled_luma(
    uint8_t *alpha_a, int stride_a, uint8_t *image_b, int stride_b, int width, int height)
{
    int i, j;
...
mlt_transition transition_matte_init(mlt_profile profile,
