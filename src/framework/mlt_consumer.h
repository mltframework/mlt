...
MLT_API int mlt_consumer_init(mlt_consumer self, void *child, mlt_profile profile);
MLT_API mlt_consumer mlt_consumer_new(mlt_profile profile);
MLT_API mlt_service mlt_consumer_service(mlt_consumer self);
MLT_API mlt_properties mlt_consumer_properties(mlt_consumer self);
MLT_API int mlt_consumer_connect(mlt_consumer self, mlt_service producer);
MLT_API int mlt_consumer_start(mlt_consumer self);
MLT_API void mlt_consumer_purge(mlt_consumer self);
MLT_API int mlt_consumer_put_frame(mlt_consumer self, mlt_frame frame);
MLT_API mlt_frame mlt_consumer_get_frame(mlt_consumer self);
MLT_API mlt_frame mlt_consumer_rt_frame(mlt_consumer self);
MLT_API int mlt_consumer_stop(mlt_consumer self);
MLT_API int mlt_consumer_is_stopped(mlt_consumer self);
MLT_API void mlt_consumer_stopped(mlt_consumer self);
